...
La MétéoBox est une petite station d’alerte météorologique par SMS qui fonctionne sans carte SIM grâce au wifi, pour intérieur ou extérieur. [Voir le code](projet_innovez.ino).
